...
/**
 * Animation that can be referred by name. Essential to use com.ilexiconn.llibrary.client.model.tabula.animation.AnimationPlayerAnimator AnimationPlayerAnimator.
 * @author jglrxavpok
 */
