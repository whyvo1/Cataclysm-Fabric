...
public class BasicModelPart {
    ...
    public void translateAndRotate(MatrixStack p_104300_) {
        p_104300_.translate(this.rotationPointX / 16.0F, this.rotationPointY / 16.0F, this.rotationPointZ / 16.0F);
        if (this.rotateAngleX != 0.0F || this.rotateAngleY != 0.0F || this.rotateAngleZ != 0.0F) {
            p_104300_.multiply((new Quaternionf()).rotationZYX(this.rotateAngleZ, this.rotateAngleY, this.rotateAngleX));
        }
