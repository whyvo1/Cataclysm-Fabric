...
public abstract class BasicEntityModel<T extends Entity> extends EntityModel<T> {
    ...
    @Override
    public void render(MatrixStack p_103013_, VertexConsumer p_103014_, int p_103015_, int p_103016_, int color) {
        this.parts().forEach((p_103030_) -> {
            p_103030_.render(p_103013_, p_103014_, p_103015_, p_103016_, color);
        });
    }
