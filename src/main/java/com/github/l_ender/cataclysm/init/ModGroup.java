...
public class ModGroup {
    ...
    public static final ItemGroup ITEM = registerItemGroup("cataclysm_item", FabricItemGroup.builder()
    ...
    public static final ItemGroup BLOCK = registerItemGroup("cataclysm_block", FabricItemGroup.builder()
            ...
            .entries((enabledFeatures, entries) -> {
                ...
                entries.add(ModItems.ALTAR_OF_FIRE);
                entries.add(ModItems.ALTAR_OF_VOID);
                entries.add(ModItems.ALTAR_OF_AMETHYST);
                entries.add(ModItems.ALTAR_OF_ABYSS);
                entries.add(ModItems.CURSED_TOMBSTONE);
                entries.add(ModItems.EMP);
                entries.add(ModItems.MECHANICAL_FUSION_ANVIL);
                entries.add(ModItems.DOOR_OF_SEAL);
                entries.add(ModItems.ABYSSAL_EGG);
...
//            .withTabsBefore(ITEM.getKey())
    ...
    private static void createLaserGatling(ItemGroup.Entries output) {
        ItemStack loreSword = new ItemStack(ModItems.LASER_GATLING);
        loreSword.set(ModDataComponents.LASER_GATLING, false);

        output.add(loreSword);
    }
