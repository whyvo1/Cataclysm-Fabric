...
public class ModTag {
    ...
    public static final TagKey<Biome> SPAWNS_DEEPLINGS = registerBiomeTag("spawns_deeplings");

    public static final TagKey<Biome> SPAWNS_AMETHYST_CRAB = registerBiomeTag("spawns_amethyst_crab");

    public static final TagKey<Biome> SPAWNS_KOBOLETON = registerBiomeTag("spawns_koboleton");

    public static final TagKey<Biome> BERSERKER_SPAWN_BIOME = registerBiomeTag("berserker_spawn");

//    public static final LazyTagLookup<StatusEffect> EFFECTIVE_FOR_BOSSES_LOOKUP = LazyTagLookup.create(ForgeRegistries.MOB_EFFECTS, EFFECTIVE_FOR_BOSSES);
    ...
    public static <T> boolean isInTag(T value, TagKey<T> tagKey) {
        ...
        Registry<T> registry = (Registry<T>) Registries.STATUS_EFFECT.get(tagKey.registry().getValue());
