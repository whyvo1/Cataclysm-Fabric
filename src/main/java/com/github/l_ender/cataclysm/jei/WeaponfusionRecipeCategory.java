...
//    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, WeaponfusionRecipe recipe, @NotNull IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 108, 1)
                .addItemStack(recipe.getOutput(DynamicRegistryManager.EMPTY));
    }
