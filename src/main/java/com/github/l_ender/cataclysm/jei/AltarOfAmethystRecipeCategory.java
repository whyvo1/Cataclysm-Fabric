...
//    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, AltarOfAmethystRecipe recipe, @NotNull IFocusGroup focuses) {
    ...
    @Override
    public boolean isHandled(@NotNull AltarOfAmethystRecipe recipe) {
        return true;
    }
