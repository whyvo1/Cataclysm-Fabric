        ...
        if(isRush()) {
            ...
            if (temp > 0) {
                ...
                if(temp % 2 ==0){
                    ...
                    owner.getWorld().addParticle(new RingParticleOptions(yaw2, 0, 20, 86, 236, 204, 1.0f, 30f, false, 2), x, y, z, 0, 0, 0);

                    owner.getWorld().addParticle(new RingParticleOptions(yaw3, 0, 20, 86, 236, 204, 1.0f, 30f, false, 2), x, y, z, 0, 0, 0);
