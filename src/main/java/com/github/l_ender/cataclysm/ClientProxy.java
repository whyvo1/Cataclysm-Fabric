...
//    }
    ...
    public void setupParticles() {
        ...
        registry.register(ModParticle.LIGHTNING, new LightningParticle.OrbFactory());
        registry.register(ModParticle.TRACK_LIGHTNING, new TrackLightningParticle.OrbFactory());
        registry.register(ModParticle.STORM, new StormParticle.OrbFactory());
        ...
        registry.register(ModParticle.LIGHT_TRAIL, new LightTrailParticle.OrbFactory());
...
//        MinecraftForge.EVENT_BUS.register(new ClientEvent());
        ...
        try {
            ModelPredicateProviderRegistry.register(ModItems.BULWARK_OF_THE_FLAME, new Identifier("blocking"), (stack, p_239421_1_, p_239421_2_, j) -> p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getActiveItem() == stack ? 1.0F : 0.0F);
            ModelPredicateProviderRegistry.register(ModItems.SOUL_RENDER, new Identifier("blocking"), (stack, p_239421_1_, p_239421_2_, j) -> p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getActiveItem() == stack ? 1.0F : 0.0F);
            ModelPredicateProviderRegistry.register(ModItems.CORAL_SPEAR, new Identifier("throwing"), (stack, p_239421_1_, p_239421_2_, j) -> p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getActiveItem() == stack ? 1.0F : 0.0F);
            ModelPredicateProviderRegistry.register(ModItems.CORAL_BARDICHE, new Identifier("throwing"), (stack, p_239421_1_, p_239421_2_, j) -> p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getActiveItem() == stack ? 1.0F : 0.0F);
            ModelPredicateProviderRegistry.register(ModItems.MEAT_SHREDDER, new Identifier("using"), (stack, p_239421_1_, p_239421_2_, j) -> p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getActiveItem() == stack ? 1.0F : 0.0F);
            ...
            ModelPredicateProviderRegistry.register(ModItems.CORAL_CHUNK, new Identifier("chunk"), (stack, level, living, j) -> (stack.getCount() % 3 == 0) ? 0.0F : (stack.getCount() % 3 == 1) ? 0.5F : 1.0F);
            ModelPredicateProviderRegistry.register(ModItems.BLACK_STEEL_TARGE, new Identifier("blocking"), (stack, p_239421_1_, p_239421_2_, j) -> p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getActiveItem() == stack ? 1.0F : 0.0F);
...
//        HandledScreens.register(ModMenu.WEAPON_FUSION, GUIWeponfusion::new);
...
//    }
    ...
    private void registerKeybinds() {
        KeyBindingHelper.registerKeyBinding(ModKeybind.KEY_ABILITY);
        KeyBindingHelper.registerKeyBinding(ModKeybind.HELMET_KEY_ABILITY);
        KeyBindingHelper.registerKeyBinding(ModKeybind.CHESTPLATE_KEY_ABILITY);
        KeyBindingHelper.registerKeyBinding(ModKeybind.BOOTS_KEY_ABILITY);
    }
