...
public class ModTemplate extends Item {
    ...
    private static final Text INGREDIENTS_TITLE = Text.translatable(Util.createTranslationKey("item", new Identifier("smithing_template.ingredients"))).formatted(TITLE_FORMAT);
    private static final Text APPLIES_TO_TITLE = Text.translatable(Util.createTranslationKey("item", new Identifier("smithing_template.applies_to"))).formatted(TITLE_FORMAT);
    ...
    public void appendTooltip(ItemStack p_267313_, @Nullable World p_266896_, List<Text> p_266820_, TooltipContext p_266857_) {
        super.appendTooltip(p_267313_, p_266896_, p_266820_, p_266857_);
