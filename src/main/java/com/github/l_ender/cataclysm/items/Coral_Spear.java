...
public class Coral_Spear extends TridentItem implements ProjectileItem {

    public Coral_Spear(net.minecraft.item.Item.Settings p_43381_) {
        super(p_43381_);
    ...
    public static AttributeModifiersComponent createAttributes() {
        return AttributeModifiersComponent.builder()
                .add(
                        EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, 5.5D, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND
                )
                .add(
    ...
    public ProjectileEntity createEntity(World p_338505_, Position p_338277_, ItemStack p_338353_, Direction p_338220_) {
        ThrownCoral_Spear_Entity throwntrident = new ThrownCoral_Spear_Entity(p_338505_, p_338277_.getX(), p_338277_.getY(), p_338277_.getZ(), p_338353_.copyWithCount(1));
