...
public class MonstrousEyeItem extends Item {
    ...
    public MonstrousEyeItem(Settings group) {
        super(group);
    }
    ...
    public TypedActionResult<ItemStack> use(World p_41184_, PlayerEntity p_41185_, Hand p_41186_) {
        ...
        if (p_41184_ instanceof ServerWorld serverlevel) {
            BlockPos blockpos = serverlevel.locateStructure(ModTag.EYE_OF_MONSTROUS_LOCATED, p_41185_.getBlockPos(), 100, false);
            if (blockpos != null) {
                ...
                p_41184_.playSound(null, p_41185_.getX(), p_41185_.getY(), p_41185_.getZ(), SoundEvents.ENTITY_ENDER_EYE_LAUNCH, SoundCategory.NEUTRAL, 0.5F, 0.4F / (p_41184_.getRandom().nextFloat() * 0.4F + 0.8F));
                p_41184_.syncWorldEvent(null, 1003, p_41185_.getBlockPos(), 0);
