...
public class Cursed_Pyramid_Structure extends CataclysmStructure {
    ...
    public static final MapCodec<Cursed_Pyramid_Structure> CODEC = createCodec(Cursed_Pyramid_Structure::new);
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        public Piece(StructureTemplateManager templateManagerIn, NbtCompound tagCompound) {
            super(ModStructures.CPD, tagCompound, templateManagerIn, (p_162451_) -> {
            ...
            switch (function) {
                case "necklace" -> {
                    ...
                    worldIn.getBlockEntity(pos, BlockEntityType.BRUSHABLE_BLOCK).ifPresent((blockEntity) -> {
                        RegistryKey<LootTable> lootTableLocation = RegistryKey.of(RegistryKeys.LOOT_TABLE,Cataclysm.modIdentifier("archaeology/cursed_pyramid_necklace"));
                ...
                case "sus" -> {
                    worldIn.setBlockState(pos, Blocks.SUSPICIOUS_SAND.getDefaultState(), 2);
                    worldIn.getBlockEntity(pos, BlockEntityType.BRUSHABLE_BLOCK).ifPresent((blockEntity) -> {
                        RegistryKey<LootTable> lootTableLocation = RegistryKey.of(RegistryKeys.LOOT_TABLE,Cataclysm.modIdentifier("archaeology/cursed_pyramid"));
                        blockEntity.setLootTable(lootTableLocation, pos.asLong());
                    });
                }
                case "koboleton" -> {
                    ...
                    if (koboleton != null) {
                        ...
                        koboleton.initialize(worldIn, worldIn.getLocalDifficulty(koboleton.getBlockPos()), SpawnReason.STRUCTURE, null);
                ...
                case "wadjet" -> {
                    ...
                    if (wadjet != null) {
                        ...
                        wadjet.initialize(worldIn, worldIn.getLocalDifficulty(wadjet.getBlockPos()), SpawnReason.STRUCTURE, null);
                ...
                case "kobolediator" -> {
                    ...
                    if (kobolediator != null) {
                        ...
                        kobolediator.initialize(worldIn, worldIn.getLocalDifficulty(kobolediator.getBlockPos()), SpawnReason.STRUCTURE, null);
                ...
                case "remnant" -> {
                    ...
                    if (remnant != null) {
                        ...
                        remnant.initialize(worldIn, worldIn.getLocalDifficulty(remnant.getBlockPos()), SpawnReason.STRUCTURE, null);
