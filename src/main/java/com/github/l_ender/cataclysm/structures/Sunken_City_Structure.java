...
public class Sunken_City_Structure extends Structure {
    ...
    public static final MapCodec<Sunken_City_Structure> CODEC = createCodec(Sunken_City_Structure::new);
    ...
    public Optional<StructurePosition> getStructurePosition(Context p_228964_) {
        ...
        return getStructurePosition(p_228964_, Heightmap.Type.OCEAN_FLOOR_WG, (p_228967_) -> {
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        public Piece(StructureTemplateManager templateManagerIn, NbtCompound tagCompound) {
            super(ModStructures.SCP, tagCompound, templateManagerIn, (p_162451_) -> {
        ...
        protected void handleMetadata(String function, BlockPos pos, ServerWorldAccess worldIn, Random rand, BlockBox sbb) {
            ...
            for(MobEntity mob : list) {
                ...
                mob.initialize(worldIn, worldIn.getLocalDifficulty(mob.getBlockPos()), SpawnReason.STRUCTURE, null);
