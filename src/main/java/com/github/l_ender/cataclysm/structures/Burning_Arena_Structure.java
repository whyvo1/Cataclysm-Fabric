...
public class Burning_Arena_Structure extends Structure {
    ...
    public static final Codec<Burning_Arena_Structure> CODEC = createCodec(Burning_Arena_Structure::new);
    ...
    public Optional<StructurePosition> getStructurePosition(Context p_228964_) {
        ...
        return Optional.of(new StructurePosition(blockpos, (p_228526_) -> generatePieces(p_228526_, p_228964_)));
    }
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        public Piece(StructureTemplateManager templateManagerIn, NbtCompound tagCompound) {
            super(ModStructures.BAP, tagCompound, templateManagerIn, (p_162451_) -> makeSettings(BlockRotation.valueOf(tagCompound.getString("Rot"))));
