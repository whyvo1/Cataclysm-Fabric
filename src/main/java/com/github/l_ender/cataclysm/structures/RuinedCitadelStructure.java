...
public class RuinedCitadelStructure extends Structure {
    ...
    public static final MapCodec<RuinedCitadelStructure> CODEC = createCodec(RuinedCitadelStructure::new);
    ...
    public Optional<StructurePosition> getStructurePosition(Context p_228964_) {
        ...
        return getStructurePosition(p_228964_, Heightmap.Type.WORLD_SURFACE_WG, (p_228967_) -> {
