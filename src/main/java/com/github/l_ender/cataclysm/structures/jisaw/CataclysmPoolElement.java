...
public abstract class CataclysmPoolElement extends StructurePoolElement {
    ...
    public static <E extends CataclysmPoolElement> RecordCodecBuilder<E, Optional<Integer>> maxCountCodec() {
        return Codecs.NONNEGATIVE_INT.optionalFieldOf("max_count").forGetter(CataclysmPoolElement::getMaxCount);
    }

    public static <E extends CataclysmPoolElement> RecordCodecBuilder<E, Optional<Integer>> minRequiredDepthCodec() {
        return Codecs.NONNEGATIVE_INT.optionalFieldOf("min_required_depth").forGetter(CataclysmPoolElement::getMinRequiredDepth);
    }

    public static <E extends CataclysmPoolElement> RecordCodecBuilder<E, Optional<Integer>> maxPossibleDepthCodec() {
        return Codecs.NONNEGATIVE_INT.optionalFieldOf("max_possible_depth").forGetter(CataclysmPoolElement::getMaxPossibleDepth);
    }
    ...
    public static <E extends CataclysmPoolElement> RecordCodecBuilder<E, StructureCondition> conditionCodec() {
        return StructureConditionType.CONDITION_CODEC.optionalFieldOf("condition", AlwaysTrueCondition.ALWAYS_TRUE).forGetter(CataclysmPoolElement::getCondition);
    }
