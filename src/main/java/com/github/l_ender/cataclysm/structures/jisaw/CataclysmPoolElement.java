...
public class CataclysmPoolElement extends SinglePoolElement {
    ...
    protected CataclysmPoolElement(Either<Identifier, StructureTemplate> p_210415_, RegistryEntry<StructureProcessorList> p_210416_, StructurePool.Projection p_210417_,
    ...
    public static boolean canAttachTwoWays(StructureTemplate.StructureBlockInfo p_54246_, StructureTemplate.StructureBlockInfo p_54247_) {
        ...
        JigsawBlockEntity.Joint jigsawblockentity$jointtype = null;
        if (p_54246_.nbt() != null) {
            jigsawblockentity$jointtype = JigsawBlockEntity.Joint.byName(p_54246_.nbt().getString("joint")).orElseGet(() -> direction.getAxis().isHorizontal() ? JigsawBlockEntity.Joint.ALIGNED : JigsawBlockEntity.Joint.ROLLABLE);
        }
        boolean flag = jigsawblockentity$jointtype == JigsawBlockEntity.Joint.ROLLABLE;
        if (p_54246_.nbt() != null && p_54247_.nbt() != null) {
    ...
    public BlockBox getBoundingBox(StructureTemplateManager structureManager, BlockPos blockPos, BlockRotation rotation) {
        ...
        BlockPos blockpos = StructureTemplate.transformAround(BlockPos.ORIGIN.add(bounds.boundsMinOffset), BlockMirror.NONE, rotation, BlockPos.ORIGIN);
        BlockPos blockpos1 = StructureTemplate.transformAround(BlockPos.ORIGIN.add(sizeVec).add(bounds.boundsMaxOffset), BlockMirror.NONE, rotation, BlockPos.ORIGIN);
    ...
    public BlockBox getCheckBoundingBox(StructureTemplateManager structureManager, BlockPos blockPos, BlockRotation rotation) {
        ...
        Vec3i sizeVec = structuretemplate.getSize().add(-1, -1, -1);
        BlockPos blockpos = StructureTemplate.transformAround(BlockPos.ORIGIN.add(bounds.boundsMinOffset).add(bounds.checkBoundsMinOffset), BlockMirror.NONE, rotation, BlockPos.ORIGIN);
        BlockPos blockpos1 = StructureTemplate.transformAround(BlockPos.ORIGIN.add(sizeVec).add(bounds.boundsMaxOffset).add(bounds.checkBoundsMaxOffset), BlockMirror.NONE, rotation, BlockPos.ORIGIN);
        return BlockBox.create(blockpos, blockpos1).move(blockPos);
    }
    ...
    public BlockBox getInteriorBoundingBox(StructureTemplateManager structureManager, BlockPos blockPos, BlockRotation rotation) {
        ...
        Vec3i sizeVec = structuretemplate.getSize().add(-1, -1, -1);
        BlockPos blockpos = StructureTemplate.transformAround(BlockPos.ORIGIN.add(bounds.boundsMinOffset).add(interiorBoundsMinOffset), BlockMirror.NONE, rotation, BlockPos.ORIGIN);
        BlockPos blockpos1 = StructureTemplate.transformAround(BlockPos.ORIGIN.add(sizeVec).add(bounds.boundsMaxOffset).add(interiorBoundsMaxOffset), BlockMirror.NONE, rotation, BlockPos.ORIGIN);
        return BlockBox.create(blockpos, blockpos1).move(blockPos);
    }
