...
public abstract class CataclysmJigsawPoolElement extends StructurePoolElement {
     ...
     * ({@link AnyOfLootCondition}, {@link AllOfLootCondition})
     */
    ...
    public static <E extends CataclysmJigsawPoolElement> RecordCodecBuilder<E, Optional<Integer>> maxCountCodec() {
        return Codecs.NONNEGATIVE_INT.optionalFieldOf("max_count").forGetter(CataclysmJigsawPoolElement::getMaxCount);
    }

    public static <E extends CataclysmJigsawPoolElement> RecordCodecBuilder<E, Optional<Integer>> minRequiredDepthCodec() {
        return Codecs.NONNEGATIVE_INT.optionalFieldOf("min_required_depth").forGetter(CataclysmJigsawPoolElement::getMinRequiredDepth);
    }

    public static <E extends CataclysmJigsawPoolElement> RecordCodecBuilder<E, Optional<Integer>> maxPossibleDepthCodec() {
        return Codecs.NONNEGATIVE_INT.optionalFieldOf("max_possible_depth").forGetter(CataclysmJigsawPoolElement::getMaxPossibleDepth);
    }
    ...
    public static <E extends CataclysmJigsawPoolElement> RecordCodecBuilder<E, StructureCondition> conditionCodec() {
        return StructureConditionType.CONDITION_CODEC.optionalFieldOf("condition", AlwaysTrueCondition.ALWAYS_TRUE).forGetter(CataclysmJigsawPoolElement::getCondition);
    }
