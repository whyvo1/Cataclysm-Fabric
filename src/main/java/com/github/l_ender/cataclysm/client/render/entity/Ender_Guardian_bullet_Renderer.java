...
{
	private static final Identifier ENDER_GUARDIAN_TEXTURE = Cataclysm.modIdentifier("textures/entity/shulkerbullet.png");
	private static final RenderLayer ENDER_GUARDIAN_RENDER_TYPE = RenderLayer.getEntityTranslucent(ENDER_GUARDIAN_TEXTURE);
	public Ender_Guardian_Bullet_Model model;

	public Ender_Guardian_bullet_Renderer(EntityRendererFactory.Context manager)
	{
		super(manager);
	...
	@Override
	public void render(Ender_Guardian_Bullet_Entity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn)
	{
		matrixStackIn.push();
		...
		matrixStackIn.translate(0.0D, 0.15D, 0.0D);
		...
		VertexConsumer VertexConsumer = bufferIn.getBuffer(this.model.getLayer(ENDER_GUARDIAN_TEXTURE));
		...
		this.model.render(matrixStackIn, VertexConsumer1, packedLightIn, OverlayTexture.DEFAULT_UV, 1.0F, 1.0F, 1.0F, 0.15F);
		matrixStackIn.pop();
		super.render(entityIn, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
	}

	@Override
	public Identifier getTexture(Ender_Guardian_Bullet_Entity entity)
	{
