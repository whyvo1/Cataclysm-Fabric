...
//        VertexConsumer consumer = ItemRenderer.getArmorGlintConsumer(buffer, RenderLayer.getArmorCutoutNoCull(getCuriosTexture()), stack.hasGlint());
//        this.model.render(poseStack, consumer, packedLight, OverlayTexture.DEFAULT_UV);
//    }

    @Override
    public void render(ItemStack stack, SlotReference slotReference, EntityModel<? extends LivingEntity> contextModel, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
        TrinketRenderer.followBodyRotations(entity, this.model);
        VertexConsumer consumer = ItemRenderer.getArmorGlintConsumer(vertexConsumers, RenderLayer.getArmorCutoutNoCull(getCuriosTexture()), stack.hasGlint());
