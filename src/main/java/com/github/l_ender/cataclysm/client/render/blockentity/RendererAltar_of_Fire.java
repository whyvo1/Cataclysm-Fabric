...
public class RendererAltar_of_Fire<T extends AltarOfFire_Block_Entity> implements BlockEntityRenderer<T> {
    ...
    public void render(T tileEntityIn, float partialTicks, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        MODEL.render(matrixStackIn, bufferIn.getBuffer(CMRenderTypes.getGlowingEffect(getIdleTexture((int) ((f2 * 0.5F) % 7)))), 210, OverlayTexture.DEFAULT_UV);
        matrixStackIn.pop();
    ...
    public void drawVertex(MatrixStack.Entry p_324380_, VertexConsumer p_253902_, int p_254058_, int p_254338_, int p_254196_, float p_254003_, float p_254165_, int p_253982_, int p_254037_, int p_254038_, int p_254271_) {
        p_253902_.vertex(p_324380_, (float)p_254058_, (float)p_254338_, (float)p_254196_).color(255, 255, 255, 255).texture(p_254003_, p_254165_).overlay(OverlayTexture.DEFAULT_UV).light(p_254271_).normal(p_324380_, (float)p_253982_, (float)p_254038_, (float)p_254037_);
    }
}
