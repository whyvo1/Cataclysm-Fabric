...
public class ClientEvent {
    ...
    private static FluidRenderer previousFluidRenderer;
...
//            }
//
//            if (MinecraftClient.getInstance().player.getStatusEffect(ModEffect.EFFECTSTUN) != null) {
//                StatusEffectInstance effectinstance1 = MinecraftClient.getInstance().player.getStatusEffect(ModEffect.EFFECTSTUN);
...
//        PlayerEntity player = MinecraftClient.getInstance().player;
//        if (player != null) {
//            if (player.hasStatusEffect(ModEffect.EFFECTCURSE_OF_DESERT)) {
...
//        if (player != null) {
//            MinecraftClient mc = MinecraftClient.getInstance();
//            if (VanillaGuiLayers.AIR_LEVEL == event.getName() && !mc.options.hudHidden && shouldDrawSurvivalElements()) {
//
//            }
//        }
//    }
...
//        MinecraftClient mc = MinecraftClient.getInstance();
//        return mc.interactionManager.hasStatusBars() && mc.getCameraEntity() instanceof PlayerEntity;
//    }
...
//            matrixStackIn.push();
//            VertexConsumer ivertexbuilder = ItemRenderer.getArmorGlintConsumer(event.getMultiBufferSource(),CMRenderTypes.getGlowingEffect(FLAME_STRIKE), true);
...
//    public static void drawVertex( MatrixStack.Entry p_229039_2_, VertexConsumer p_229039_3_, int p_229039_4_, int p_229039_5_, int p_229039_6_, float p_229039_7_, float p_229039_8_, int p_229039_9_, int p_229039_10_, int p_229039_11_, int p_229039_12_) {
...
//                MinecraftClient.getInstance().worldRenderer.chunks.chunks[i].scheduleRebuild(true);
//            }
//        }
//    }
...
//                    }
//                }
//                previousLavaVision = itemstack.isIn(ModItems.IGNITIUM_HELMET.get());
//            }
//        }
//    }
...
//        int width = stack.getScaledWindowWidth();
//        int height = stack.getScaledWindowHeight();
//        event.setCanceled(true);
