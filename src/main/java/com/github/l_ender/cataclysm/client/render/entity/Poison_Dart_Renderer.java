...
//        float f8 = 0.05625F;
    ...
    public void vertex(MatrixStack.Entry p_324380_, VertexConsumer p_253902_, int p_254058_, int p_254338_, int p_254196_, float p_254003_, float p_254165_, int p_253982_, int p_254037_, int p_254038_, int p_254271_) {
        p_253902_.vertex(p_324380_, (float)p_254058_, (float)p_254338_, (float)p_254196_).color(-1).texture(p_254003_, p_254165_).overlay(OverlayTexture.DEFAULT_UV).light(p_254271_).normal(p_324380_, (float)p_253982_, (float)p_254038_, (float)p_254037_);
    }
}
