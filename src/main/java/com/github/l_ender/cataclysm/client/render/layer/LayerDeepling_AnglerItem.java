...
public class LayerDeepling_AnglerItem extends FeatureRenderer<Deepling_Angler_Entity, Deepling_Angler_Model> {
    private final HeldItemRenderer itemInHandRenderer;

    public LayerDeepling_AnglerItem(FeatureRendererContext p_234846_, HeldItemRenderer p_234847_) {
        super(p_234846_);
        this.itemInHandRenderer = p_234847_;
    }

    public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn, Deepling_Angler_Entity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
