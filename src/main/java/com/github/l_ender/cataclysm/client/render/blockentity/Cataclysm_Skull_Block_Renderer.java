...
public class Cataclysm_Skull_Block_Renderer implements BlockEntityRenderer<Cataclysm_Skull_BlockEntity> {
    ...
    public Cataclysm_Skull_Block_Renderer(BlockEntityRendererFactory.Context p_173660_) {
    ...
    public static void renderSkull(@Nullable Direction p_173664_, float p_173665_, float p_173666_, MatrixStack p_173667_, VertexConsumerProvider p_173668_, int p_173669_, Cataclysm_Skull_Model_Base p_173670_, RenderLayer p_173671_) {
        p_173667_.push();
        if (p_173664_ == null) {
        ...
        p_173670_.render(p_173667_, vertexconsumer, p_173669_, OverlayTexture.DEFAULT_UV, 1.0F, 1.0F, 1.0F, 1.0F);
        p_173667_.pop();
    }
}
