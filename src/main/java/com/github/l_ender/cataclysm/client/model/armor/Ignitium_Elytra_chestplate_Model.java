...
public class Ignitium_Elytra_chestplate_Model extends BipedEntityModel<LivingEntity> {
    ...
    public void setAngles(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity instanceof AbstractClientPlayerEntity abstractclientplayer) {
            abstractclientplayer.elytraPitch += (f - abstractclientplayer.elytraPitch) * 0.1F;
            abstractclientplayer.elytraYaw += (f3 - abstractclientplayer.elytraYaw) * 0.1F;
            abstractclientplayer.elytraRoll += (f1 - abstractclientplayer.elytraRoll) * 0.1F;
            this.leftWing.pitch = abstractclientplayer.elytraPitch;
            this.leftWing.yaw = abstractclientplayer.elytraYaw;
            this.leftWing.roll = abstractclientplayer.elytraRoll;
        } else {
