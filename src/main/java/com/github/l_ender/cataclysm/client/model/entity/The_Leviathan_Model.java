...
public class The_Leviathan_Model extends AdvancedEntityModel<The_Leviathan_Entity> {
	...
	@Override
	public void setAngles(The_Leviathan_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
...
//		boolean swimAnimate = entityIn.isTouchingWater();
...
//		}
	...
	public Vec3d translateToTongue(Vec3d in, float yawIn) {
		MatrixStack modelTranslateStack = new MatrixStack();
		modelTranslateStack.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(180.0F - yawIn));
		modelTranslateStack.translate(root.rotationPointX / 16.0F, root.rotationPointY / 16.0F, (double) (root.rotationPointZ / 16.0F));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Z.rotation(root.rotateAngleZ));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Y.rotation(root.rotateAngleY));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_X.rotation(root.rotateAngleX));
		modelTranslateStack.translate(body.rotationPointX / 16.0F, body.rotationPointY / 16.0F, (double) (body.rotationPointZ / 16.0F));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Z.rotation(body.rotateAngleZ));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Y.rotation(body.rotateAngleY));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_X.rotation(body.rotateAngleX));
		modelTranslateStack.translate(Head.rotationPointX / 16.0F, Head.rotationPointY / 16.0F, (double) (Head.rotationPointZ / 16.0F));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Z.rotation(Head.rotateAngleZ));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Y.rotation(Head.rotateAngleY));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_X.rotation(Head.rotateAngleX));
		modelTranslateStack.translate(tongue.rotationPointX / 16.0F, tongue.rotationPointY / 16.0F, (double) (tongue.rotationPointZ / 16.0F));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Z.rotation(tongue.rotateAngleZ));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_Y.rotation(tongue.rotateAngleY));
		modelTranslateStack.multiply(RotationAxis.NEGATIVE_X.rotation(tongue.rotateAngleX));
		Vector4f tongueOffsetVec = new Vector4f((float) in.x, (float) in.y, (float) in.z, 1.0F);
		tongueOffsetVec.mul(modelTranslateStack.peek().getPositionMatrix());
		Vec3d offset = new Vec3d(tongueOffsetVec.x(), tongueOffsetVec.y(), tongueOffsetVec.z());
		modelTranslateStack.pop();
		return offset;
	}
