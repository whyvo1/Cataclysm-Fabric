...
public class Old_Netherite_Monstrosity_Model extends AdvancedEntityModel<Old_Netherite_Monstrosity_Entity> {
	...
	@Override
	public void setAngles(Old_Netherite_Monstrosity_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.walk(leftleg, walkSpeed, walkDegree, false, -25F, 0F, limbSwing, limbSwingAmount);
		this.flap(root, walkSpeed, walkDegree * 0.1F, false, 0F, 0F, limbSwing, limbSwingAmount);
		this.walk(rightleg, walkSpeed, walkDegree, true, -25F, 0F, limbSwing, limbSwingAmount);
