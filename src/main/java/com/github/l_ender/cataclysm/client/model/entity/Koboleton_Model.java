...
public class Koboleton_Model extends AdvancedEntityModel<Koboleton_Entity> {
	...
	@Override
	public void setAngles(Koboleton_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.right_arm.rotationPointY -= MathHelper.cos(ageInTicks * walkSpeed * 0.1F+ 1F) * 0.5F + 0.5F;
		this.left_arm.rotationPointY -= MathHelper.cos(ageInTicks * walkSpeed * 0.1F+ 1F) * 0.5F + 0.5F;

		this.right_arm.rotationPointZ += MathHelper.cos(ageInTicks * walkSpeed * 0.1F) - 1.0F;
		this.left_arm.rotationPointZ += MathHelper.cos(ageInTicks * walkSpeed * 0.1F) - 1.0F;
