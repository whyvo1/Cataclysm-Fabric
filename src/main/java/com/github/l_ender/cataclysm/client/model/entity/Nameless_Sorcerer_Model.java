...
public class Nameless_Sorcerer_Model extends AdvancedEntityModel<Nameless_Sorcerer_Entity> {
    ...
    @Override
    public void setAngles(Nameless_Sorcerer_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        IllagerEntity.State abstractillagerentity$armpose = entityIn.getState();
        if (abstractillagerentity$armpose == IllagerEntity.State.SPELLCASTING) {
