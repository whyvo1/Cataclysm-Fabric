...
//        boolean left = transformType == ModelTransformationMode.THIRD_PERSON_LEFT_HAND || transformType == ModelTransformationMode.FIRST_PERSON_LEFT_HAND;
        ...
        if (itemStackIn.getItem() == ModItems.BULWARK_OF_THE_FLAME) {
            ...
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(BULWARK_OF_THE_FLAME_TEXTURE), itemStackIn.hasGlint());
            BULWARK_OF_THE_FLAME_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.getItem() == ModItems.BLACK_STEEL_TARGE) {
            matrixStackIn.push();
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(BLACK_STEEL_TARGE_TEXTURE), itemStackIn.hasGlint());
            BLACK_STEEL_TARGE_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.getItem() == ModItems.GAUNTLET_OF_GUARD) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(GAUNTLET_OF_GUARD_TEXTURE), itemStackIn.hasGlint());
            GAUNTLET_OF_GUARD_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(GAUNTLET_OF_GUARD_LAYER_TEXTURE), itemStackIn.hasGlint());
            GAUNTLET_OF_GUARD_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.getItem() == ModItems.GAUNTLET_OF_BULWARK) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(GAUNTLET_OF_BULWARK_TEXTURE), itemStackIn.hasGlint());
            GAUNTLET_OF_BULWARK_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(GAUNTLET_OF_BULWARK_LAYER_TEXTURE), itemStackIn.hasGlint());
            GAUNTLET_OF_BULWARK_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.getItem() == ModItems.GAUNTLET_OF_MAELSTROM) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(GAUNTLET_OF_MAELSTROM_TEXTURE), itemStackIn.hasGlint());
            GAUNTLET_OF_MAELSTROM_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(GAUNTLET_OF_MAELSTROM_LAYER_TEXTURE), itemStackIn.hasGlint());
            GAUNTLET_OF_MAELSTROM_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.getItem() == ModItems.THE_INCINERATOR) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(THE_INCINERATOR_TEXTURE), itemStackIn.hasGlint());
            THE_INCINERATOR_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.getItem() == ModItems.WITHER_ASSULT_SHOULDER_WEAPON) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(WASW_TEXTURE), itemStackIn.hasGlint());
            WASW_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(WASW_LAYER_TEXTURE), itemStackIn.hasGlint());
            WASW_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.getItem() == ModItems.VOID_ASSULT_SHOULDER_WEAPON) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(VASW_TEXTURE), itemStackIn.hasGlint());
            WASW_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(VASW_LAYER_TEXTURE), itemStackIn.hasGlint());
            WASW_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.getItem() == ModItems.CORAL_SPEAR) {
            matrixStackIn.push();
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(CORAL_SPEAR_TEXTURE), itemStackIn.hasGlint());
            CORAL_SPEAR_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.getItem() == ModItems.CORAL_BARDICHE) {
            matrixStackIn.push();
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(CORAL_BARDICHE_TEXTURE), itemStackIn.hasGlint());
            CORAL_BARDICHE_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.getItem() == ModItems.VOID_FORGE) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(VOID_FORGE_TEXTURE), itemStackIn.hasGlint());
            VOID_FORGE_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(VOID_FORGE_LAYER_TEXTURE), itemStackIn.hasGlint());
            VOID_FORGE_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
        ...
        if (itemStackIn.getItem() == ModItems.TIDAL_CLAWS) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(TIDAL_CLAWS_TEXTURE), itemStackIn.hasGlint());
            TIDAL_CLAWS_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.getItem() == ModItems.MEAT_SHREDDER) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(MEAT_SHREDDER_TEXTURE), itemStackIn.hasGlint());
            MEAT_SHREDDER_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.CMEyes(MEAT_SHREDDER_LAYER_TEXTURE), itemStackIn.hasGlint());
            MEAT_SHREDDER_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
        ...
        if (itemStackIn.getItem() == ModItems.LASER_GATLING) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getEntityCutoutNoCull(LASER_GATLING_TEXTURE), itemStackIn.hasGlint());
            ...
            LASER_GATLING_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getEyes(LASER_GATLING_LAYER_TEXTURE), itemStackIn.hasGlint());
            LASER_GATLING_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
        ...
        if (itemStackIn.getItem() == ModItems.ANCIENT_SPEAR) {
            ...
            matrixStackIn.translate(0.5F, 0.5F, 0.5F);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(ANCIENT_SPEAR_TEXTURE), itemStackIn.hasGlint());
            ANCIENT_SPEAR_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.isOf(ModItems.CURSED_BOW)) {
            ...
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(CURSED_BOW_TEXTURE), itemStackIn.hasGlint());
            CURSED_BOW_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getghost(CURSED_BOW_GHOST_TEXTURE), itemStackIn.hasGlint());
            CURSED_BOW_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
        ...
        if (itemStackIn.isOf(ModItems.WRATH_OF_THE_DESERT)) {
            ...
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(WRATH_OF_DESERT_TEXTURE), itemStackIn.hasGlint());
            WRATH_OF_DESERT_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getghost(WRATH_OF_DESERT_GHOST_TEXTURE), itemStackIn.hasGlint());
            WRATH_OF_DESERT_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.isOf(ModItems.SOUL_RENDER)) {
            ...
            matrixStackIn.translate(0.5F, 0.5f, 0.5f);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(SOUL_RENDER_TEXTURE), itemStackIn.hasGlint());
            SOUL_RENDER.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getghost(SOUL_RENDER_GHOST_TEXTURE), itemStackIn.hasGlint());
            SOUL_RENDER.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if (itemStackIn.isOf(ModItems.THE_ANNIHILATOR)) {
            ...
            matrixStackIn.translate(0.5F, 0.5f, 0.5f);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(THE_ANNIHILATOR_TEXTURE), itemStackIn.hasGlint());
            THE_ANNIHILATOR.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getghost(THE_ANNIHILATOR_GHOST_TEXTURE), itemStackIn.hasGlint());
            THE_ANNIHILATOR.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if (itemStackIn.isOf(ModItems.THE_IMMOLATOR)) {
            ...
            matrixStackIn.translate(0.5F, 0.5f, 0.5f);
            matrixStackIn.scale(1.0F, -1.0F, -1.0F);
            VertexConsumer vertexconsumer = ItemRenderer.getArmorGlintConsumer(bufferIn, RenderLayer.getArmorCutoutNoCull(THE_IMMOLATOR_TEXTURE), itemStackIn.hasGlint());
            THE_IMMOLATOR_MODEL.render(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn);
            VertexConsumer vertexconsumer2 = ItemRenderer.getArmorGlintConsumer(bufferIn, CMRenderTypes.getghost(THE_IMMOLATOR_GHOST_TEXTURE), itemStackIn.hasGlint());
            THE_IMMOLATOR_MODEL.render(matrixStackIn, vertexconsumer2, combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        ...
        if(itemStackIn.getItem() == ModBlocks.ALTAR_OF_FIRE.asItem()){
            ...
            ALTAR_OF_FIRE_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(ALTAR_OF_FIRE_TEXTURE)), combinedLightIn, combinedOverlayIn);
            ALTAR_OF_FIRE_MODEL.render(matrixStackIn, bufferIn.getBuffer(CMRenderTypes.getGlowingEffect(getIdleTexture((int) ((tick * 0.5F) % 7)))), 210, OverlayTexture.DEFAULT_UV);
            matrixStackIn.pop();
        }
        if(itemStackIn.getItem() == ModBlocks.ALTAR_OF_VOID.asItem()){
            ...
            ALTAR_OF_VOID_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(ALTAR_OF_VOID_TEXTURE)), combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if(itemStackIn.getItem() == ModBlocks.ALTAR_OF_AMETHYST.asItem()){
            ...
            ALTAR_OF_AMETHYST_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(ALTAR_OF_AMETHYST_TEXTURE)), combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if(itemStackIn.getItem() == ModBlocks.ALTAR_OF_ABYSS.asItem()){
            ...
            ALTAR_OF_ABYSS_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(ALTAR_OF_ABYSS_TEXTURE)), combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if(itemStackIn.getItem() == ModBlocks.EMP.asItem()){
            ...
            EMP_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(EMP_TEXTURE)), combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if(itemStackIn.getItem() == ModBlocks.MECHANICAL_FUSION_ANVIL.asItem()){
            ...
            MF_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(MIF_TEXTURE)), combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
        if(itemStackIn.getItem() == ModBlocks.ABYSSAL_EGG.asItem()){
            ...
            ABYSSAL_MODEL.render(matrixStackIn, bufferIn.getBuffer(RenderLayer.getEntityCutoutNoCull(ABYSSAL_EGG_TEXTURE)), combinedLightIn, combinedOverlayIn);
            ABYSSAL_MODEL.render(matrixStackIn, bufferIn.getBuffer(CMRenderTypes.getghost(ABYSSAL_EGG_LAYER_TEXTURE)), combinedLightIn, combinedOverlayIn);
            matrixStackIn.pop();
        }
    }
