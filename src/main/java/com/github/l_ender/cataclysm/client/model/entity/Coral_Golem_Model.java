...
public class Coral_Golem_Model extends AdvancedEntityModel<Coral_Golem_Entity> {
	...
	@Override
	public void setAngles(Coral_Golem_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		animate(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
		float walkSpeed = 0.5F;
		float walkDegree = 0.5F;
		float partialTick = MinecraftClient.getInstance().getTickDelta();
		float swim = entityIn.getLeaningPitch(partialTick);
