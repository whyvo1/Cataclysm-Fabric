...
public class Cursed_Sandstorm_Model extends AdvancedEntityModel<Cursed_Sandstorm_Entity> {
	...
	@Override
	public void setAngles(Cursed_Sandstorm_Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
