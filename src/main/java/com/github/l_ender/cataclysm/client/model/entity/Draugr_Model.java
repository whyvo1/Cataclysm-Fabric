...
public class Draugr_Model extends SinglePartEntityModel<Draugr_Entity> implements ModelWithArms {
	...
	public static TexturedModelData createBodyLayer() {
		...
		.uv(32, 36).cuboid(-4.0F, -3.0F, -2.0F, 8.0F, 11.0F, 4.0F, new Dilation(0.5F)), ModelTransform.of(0.0F, -12.0F, 0.0F, -0.0873F, -0.2182F, 0.0F));
		...
		.uv(40, 16).mirrored().cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(5.0F, -9.0F, 0.0F, 0.1309F, 0.0F, -0.0436F));
		...
		.uv(0, 48).cuboid(-1.0F, 2.0F, -1.0F, 2.0F, 5.0F, 2.0F, new Dilation(0.5F)), ModelTransform.of(-5.0F, -8.0F, 0.0F, 0.1309F, 0.0F, 0.0436F));

		ModelPartData right_arm_r1 = right_arm.addChild("right_arm_r1", ModelPartBuilder.create().uv(48, 18).cuboid(-1.0F, -3.0F, -1.5F, 2.0F, 5.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-2.7526F, -1.3329F, 1.5F, 0.0F, 0.0F, 0.2182F));

		ModelPartData right_arm_r2 = right_arm.addChild("right_arm_r2", ModelPartBuilder.create().uv(58, 23).cuboid(0.0F, -2.0F, -3.5F, 0.0F, 6.0F, 7.0F, new Dilation(0.0F))
		.uv(48, 23).cuboid(-1.0F, -2.0F, -1.5F, 2.0F, 4.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, -0.5F, 0.0F, 0.0F, 0.0F, 0.2182F));
		...
		.uv(0, 55).mirrored().cuboid(-10.0F, -13.0F, 0.0F, 6.0F, 8.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -12.0F, -1.0F, 0.5079F, 0.1287F, -0.137F));
	...
	@Override
	public void setAngles(Draugr_Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
