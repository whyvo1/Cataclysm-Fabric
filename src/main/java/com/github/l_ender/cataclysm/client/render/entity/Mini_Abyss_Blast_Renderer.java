...
public class Mini_Abyss_Blast_Renderer extends EntityRenderer<Mini_Abyss_Blast_Entity> {
    ...
    public Mini_Abyss_Blast_Renderer(EntityRendererFactory.Context mgr) {
        super(mgr);
    }

    @Override
    public Identifier getTexture(Mini_Abyss_Blast_Entity entity) {
        return TEXTURE;
    }
    ...
    @Override
    public void render(Mini_Abyss_Blast_Entity solarBeam, float entityYaw, float delta, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn) {
    ...
    public void drawVertex(MatrixStack.Entry normals, VertexConsumer vertexBuilder, float offsetX, float offsetY, float offsetZ, float textureX, float textureY, float alpha, int packedLightIn) {
        vertexBuilder
                .vertex(normals, offsetX, offsetY, offsetZ)
                .color(1, 1, 1, 1 * alpha)
