...
public class Deepling_Warlock_Model extends AdvancedEntityModel<Deepling_Warlock_Entity> {
	...
	@Override
	public void setAngles(Deepling_Warlock_Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		float swim = entity.getLeaningPitch(partialTick);
		float walkSpeed = 1F;
		float walkDegree = 1F;
