...
public class Ignis_Shield_Layer extends FeatureRenderer<Ignis_Entity, Ignis_Model> {
    ...
    private static final Identifier IGNIS_SHIELD = Cataclysm.modIdentifier("textures/entity/ignis/ignis_shield.png");

    private static final Identifier IGNIS_SOUL_SHIELD = Cataclysm.modIdentifier("textures/entity/ignis/ignis_soul_shield.png");

    private static final Identifier IGNIS_SHIELD_CRACK1 = Cataclysm.modIdentifier("textures/entity/ignis/ignis_shield_crack1.png");

    private static final Identifier IGNIS_SHIELD_CRACK2 = Cataclysm.modIdentifier("textures/entity/ignis/ignis_shield_crack2.png");

    private static final Identifier IGNIS_SHIELD_CRACK3 = Cataclysm.modIdentifier("textures/entity/ignis/ignis_shield_crack3.png");
    ...
    public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn, Ignis_Entity ignis, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (ignis.getShieldDurability() > 0) {
            ...
            this.model.render(matrixStackIn, lvt_13_2_, packedLightIn, OverlayTexture.DEFAULT_UV);
        }
