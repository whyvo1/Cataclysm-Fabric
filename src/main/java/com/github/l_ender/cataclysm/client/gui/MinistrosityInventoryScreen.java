...
public class MinistrosityInventoryScreen extends HandledScreen<MinistrostiyMenu> {
    ...
    public MinistrosityInventoryScreen(MinistrostiyMenu p_98817_, PlayerInventory p_98818_, Netherite_Ministrosity_Entity p_98819_, int p_352203_) {
    ...
    protected void drawBackground(DrawContext p_282553_, float p_282998_, int p_282929_, int p_283133_) {
        ...
        p_282553_.drawTexture(HORSE_INVENTORY_LOCATION, i + 70, j + 17, 0, this.backgroundHeight, inventoryColumns * 18, 54);
        InventoryScreen.drawEntity(p_282553_, i - 10, j + 18, i + 78, j + 70, 34, 0.0F, this.xMouse, this.yMouse, this.mini);
    }
