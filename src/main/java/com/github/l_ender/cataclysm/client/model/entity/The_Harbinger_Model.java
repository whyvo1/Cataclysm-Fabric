...
public class The_Harbinger_Model extends AdvancedEntityModel<The_Harbinger_Entity> {
    ...
    @Override
    public void setAngles(The_Harbinger_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float partialTick = ageInTicks - entityIn.age;
    ...
    private static void setupHeadRotation(The_Harbinger_Entity entityIn, AdvancedModelBox p_171073_, int p_171074_) {
        p_171073_.rotateAngleY += (entityIn.getHeadYRot(p_171074_) - entityIn.bodyYaw) * ((float)Math.PI / 180F);
