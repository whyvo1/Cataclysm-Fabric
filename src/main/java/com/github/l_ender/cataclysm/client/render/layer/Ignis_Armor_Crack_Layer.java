...
public class Ignis_Armor_Crack_Layer extends FeatureRenderer<Ignis_Entity, Ignis_Model> {
    ...
    private static final Map<Ignis_Entity.Crackiness, Identifier> resourceLocations = ImmutableMap.of(
            Ignis_Entity.Crackiness.LOW, new Identifier("cataclysm:textures/entity/ignis/ignis_armor_crack1.png"),
            Ignis_Entity.Crackiness.MEDIUM, new Identifier("cataclysm:textures/entity/ignis/ignis_armor_crack2.png"),
            Ignis_Entity.Crackiness.HIGH, new Identifier("cataclysm:textures/entity/ignis/ignis_armor_crack3.png"));
        ...
        if (!ignis.isInvisible()) {
            if(ignis.getBossPhase() > 0){
                ...
                if (ignis$crackiness != Ignis_Entity.Crackiness.NONE) {
                    ...
                    renderModel(this.getContextModel(), resourcelocation, matrixStackIn, bufferIn, packedLightIn, ignis, 1.0F, 1.0F, 1.0F);
                }
            }
        }
