...
public class Ancient_Remnant_Model extends AdvancedEntityModel<Ancient_Ancient_Remnant_Entity> {
	...
	@Override
	public void setAngles(Ancient_Ancient_Remnant_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		if (chargeProgress <= 0F) {
			...
			walk(left_leg, globalSpeed, globalDegree * 1.4f, true, (float) Math.PI * 0.4f, 0F, limbSwing, limbSwingAmount);
			walk(right_leg, globalSpeed, globalDegree * 1.4f, true, (float) Math.PI * 1.4f, 0F, limbSwing, limbSwingAmount);

			this.left_leg.rotationPointY += MathHelper.clamp(MathHelper.sin(limbSwing * globalSpeed) * limbSwingAmount * 10, -Float.POSITIVE_INFINITY, 1);
			this.left_leg.rotationPointZ += MathHelper.cos(limbSwing * globalSpeed + (float) Math.PI) * limbSwingAmount * 10 + limbSwingAmount * -8;

			this.right_leg.rotationPointY += MathHelper.clamp(MathHelper.sin(limbSwing * globalSpeed + (float) Math.PI) * limbSwingAmount * 10, -Float.POSITIVE_INFINITY, 1);
			this.right_leg.rotationPointZ += MathHelper.cos(limbSwing * globalSpeed) * limbSwingAmount * 10 + limbSwingAmount * -8;
			//this.right_leg.rotationPointZ += Mth.cos(limbSwing * speed + offset) * degree * limbSwingAmount + weight * limbSwingAmount;

			walk(left_front_leg, globalSpeed, 1.2F * globalDegree, false, (float) Math.PI * 0.4f + 0.1f, 0.6F * globalDegree, limbSwing, limbSwingAmount);
			walk(right_front_leg, globalSpeed, 1.2F * globalDegree, false, (float) Math.PI * 1.4f + 0.1f, 0.6F * globalDegree, limbSwing, limbSwingAmount);

			walk(left_ankel_joint, globalSpeed, 1.2F * globalDegree, false, (float) Math.PI * 0.4f + 0.2f, -1.0F * globalDegree, limbSwing, limbSwingAmount);
			walk(right_ankel_joint, globalSpeed, 1.2F * globalDegree, false, (float) Math.PI * 1.4f + 0.2f, -1.0F * globalDegree, limbSwing, limbSwingAmount);

			walk(left_foot, globalSpeed, globalDegree, true, (float) Math.PI * 0.4f + 0.3f, -globalDegree, limbSwing, limbSwingAmount);
			walk(right_foot, globalSpeed, globalDegree, true, (float) Math.PI * 1.4f + 0.3f, -globalDegree, limbSwing, limbSwingAmount);
			...
			this.right_arm.rotationPointZ += MathHelper.cos(limbSwing * globalSpeed + (float) Math.PI) * limbSwingAmount * 8 + limbSwingAmount * 8;

			this.walk(left_arm, 0.6F * globalSpeed, globalDegree, false, (float) Math.PI * 1.4f, -globalDegree, limbSwing, limbSwingAmount);

			this.left_arm.rotationPointZ += MathHelper.cos(limbSwing * globalSpeed) * limbSwingAmount * 8 + limbSwingAmount * 8;
			...
			this.swing(spine1, globalSpeed, globalDegree * 0.2F, false, 0.0f, 0, limbSwing, limbSwingAmount);

			this.swing(spine2, globalSpeed, globalDegree * 0.2F, false, 0.1f, 0, limbSwing, limbSwingAmount);
			...
			this.left_leg.rotationPointY += MathHelper.clamp(MathHelper.sin(limbSwing * 0.75F * chargeSpeed) * limbSwingAmount * 4, -Float.POSITIVE_INFINITY, 1);
			this.left_leg.rotationPointZ += MathHelper.cos(limbSwing * 0.75F * chargeSpeed + (float) Math.PI) * limbSwingAmount * 10 + limbSwingAmount * -8;

			this.right_leg.rotationPointY += MathHelper.clamp(MathHelper.sin(limbSwing * 0.75F * chargeSpeed + (float) Math.PI) * limbSwingAmount * 4, -Float.POSITIVE_INFINITY, 1);
			this.right_leg.rotationPointZ += MathHelper.cos(limbSwing * 0.75F * chargeSpeed) * limbSwingAmount * 10 + limbSwingAmount * -8;
			//this.right_leg.rotationPointZ += Mth.cos(limbSwing * speed + offset) * degree * limbSwingAmount + weight * limbSwingAmount;
			...
			walk(left_foot, 0.75F * chargeSpeed, globalDegree, true, (float) Math.PI * 0.4f + 0.3f, -globalDegree, limbSwing, limbSwingAmount);
			walk(right_foot, 0.75F * chargeSpeed, globalDegree, true, (float) Math.PI * 1.4f + 0.3f, -globalDegree, limbSwing, limbSwingAmount);
