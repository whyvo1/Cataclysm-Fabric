...
public class LayerDeeplingBruteItem extends FeatureRenderer<Deepling_Brute_Entity, Deepling_Brute_Model> {
    private final HeldItemRenderer itemInHandRenderer;

    public LayerDeeplingBruteItem(FeatureRendererContext p_234846_, HeldItemRenderer p_234847_) {
        super(p_234846_);
        this.itemInHandRenderer = p_234847_;
    }

    public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn, Deepling_Brute_Entity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
