...
public class Draugr_Renderer extends MobEntityRenderer<Draugr_Entity, Draugr_Model> {
    private static final Identifier TEXTURE = Cataclysm.modIdentifier("textures/entity/draugar/draugr.png");
    private static final Identifier LAYER = Cataclysm.modIdentifier("textures/entity/draugar/draugr_layer.png");

    public Draugr_Renderer(EntityRendererFactory.Context renderManagerIn) {
        super(renderManagerIn, new Draugr_Model(renderManagerIn.getPart(CMModelLayers.DRAUGR_MODEL)), 0.5F);
    ...
    protected void scale(Draugr_Entity p_114907_, MatrixStack p_114908_, float p_114909_) {
        float f = 1.0F;
        p_114908_.scale(f, f, f);
        super.scale(p_114907_, p_114908_, p_114909_);
    }

    public Identifier getTexture(Draugr_Entity entity) {
        return TEXTURE;
    }
