...
public class Abyss_Blast_Renderer extends EntityRenderer<Abyss_Blast_Entity> {
    ...
    public Abyss_Blast_Renderer(EntityRendererFactory.Context mgr) {
        super(mgr);
    }

    @Override
    public Identifier getTexture(Abyss_Blast_Entity entity) {
        return TEXTURE;
    }
    ...
    @Override
    public void render(Abyss_Blast_Entity solarBeam, float entityYaw, float delta, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn) {
