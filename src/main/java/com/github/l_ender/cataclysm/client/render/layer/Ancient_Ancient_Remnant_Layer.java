...
public class Ancient_Ancient_Remnant_Layer extends FeatureRenderer<Ancient_Ancient_Remnant_Entity, Ancient_Remnant_Model> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn, Ancient_Ancient_Remnant_Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
