...
{
	private static final Identifier IGNIS_FIRE_BALL = Cataclysm.modIdentifier("textures/entity/ignis_fireball.png");
	private static final Identifier IGNIS_FIRE_BALL_SOUL = Cataclysm.modIdentifier("textures/entity/ignis_fireball_soul.png");

	public Ignis_Fireball_Model model;

	public Ignis_Fireball_Renderer(EntityRendererFactory.Context manager)
	{
		super(manager);
	...
	@Override
	protected int getBlockLight(Ignis_Fireball_Entity entity, BlockPos pos)
	{
		return 15;
	}

	@Override
	public void render(Ignis_Fireball_Entity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn)
	{
		matrixStackIn.push();
	...
	@Override
	public Identifier getTexture(Ignis_Fireball_Entity entity)
	{
