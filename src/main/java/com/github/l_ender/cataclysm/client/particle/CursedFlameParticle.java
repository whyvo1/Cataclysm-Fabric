...
public class CursedFlameParticle extends AbstractSlowingParticle {
    ...
    public static class Provider implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_106838_, ClientWorld p_106839_, double p_106840_, double p_106841_, double p_106842_, double p_106843_, double p_106844_, double p_106845_) {
    ...
    public static class SmallFlameProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider sprite;
        ...
        public Particle createParticle(SimpleParticleType p_172124_, ClientWorld p_172125_, double p_172126_, double p_172127_, double p_172128_, double p_172129_, double p_172130_, double p_172131_) {
