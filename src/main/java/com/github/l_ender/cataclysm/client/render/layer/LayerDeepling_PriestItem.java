...
public class LayerDeepling_PriestItem extends FeatureRenderer<Deepling_Priest_Entity, Deepling_Priest_Model> {
    private final HeldItemRenderer itemInHandRenderer;

    public LayerDeepling_PriestItem(FeatureRendererContext p_234846_, HeldItemRenderer p_234847_) {
        super(p_234846_);
        this.itemInHandRenderer = p_234847_;
    }

    public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn, Deepling_Priest_Entity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
