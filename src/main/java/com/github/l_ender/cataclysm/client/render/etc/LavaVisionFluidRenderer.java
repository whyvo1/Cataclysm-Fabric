...
public class LavaVisionFluidRenderer extends FluidRenderer {
    ...
    private static final Identifier WATER_FLOW = new Identifier("block/water_flow");
    private static final Identifier WATER_OVERLAY = new Identifier("block/water_overlay");
    private static final Identifier LAVA_STILL = new Identifier("block/lava_still");
    private static final Identifier LAVA_FLOW = new Identifier("block/lava_flow");
                ...
                if (!flag1 && !flag2 && !flag6 && !flag5 && !flag3 && !flag4) {
                    ...
                    if (flag1 && !isFaceOccludedByNeighborVanilla(lightReaderIn, posIn, Direction.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
                        ...
                        if (vec3.x == 0.0D && vec3.z == 0.0D) {
                            ...
                            f18 = textureatlassprite1.getFrameU(0.0D);
                            f22 = textureatlassprite1.getFrameV(0.0D);
                            f19 = f18;
                            f23 = textureatlassprite1.getFrameV(16.0D);
                            f20 = textureatlassprite1.getFrameU(16.0D);
                            f24 = f23;
                            f21 = f20;
                            f25 = f22;
                        } else {
                    ...
                    for(Direction direction : Direction.Type.HORIZONTAL) {
                        ...
                        if (flag8 && !isFaceOccludedByNeighborVanilla(lightReaderIn, posIn, direction, Math.max(f44, f45), lightReaderIn.getBlockState(posIn.offset(direction)))) {
                            ...
                            float f54 = textureatlassprite2.getFrameU(0.0D);
                            float f55 = textureatlassprite2.getFrameU(8.0D);
                            float f33 = textureatlassprite2.getFrameV((1.0F - f44) * 16.0F * 0.5F);
                            float f34 = textureatlassprite2.getFrameV((1.0F - f45) * 16.0F * 0.5F);
                            float f35 = textureatlassprite2.getFrameV(8.0D);
