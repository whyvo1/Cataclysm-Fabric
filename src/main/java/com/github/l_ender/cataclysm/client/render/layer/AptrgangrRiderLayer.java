...
public class AptrgangrRiderLayer extends FeatureRenderer<Aptrgangr_Entity, Aptrgangr_Model> {

    public AptrgangrRiderLayer(Aptrgangr_Renderer render) {
        super(render);
    }

    public void render(MatrixStack poseStack, VertexConsumerProvider bufferIn, int packedLightIn, Aptrgangr_Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public Vec3d getRiderPosition(Vec3d offsetIn) {
        ...
        this.getContextModel().translateToHand(translationStack);
