...
public class Abyss_Orb_Renderer extends EntityRenderer<Abyss_Orb_Entity> {
    ...
    private static void vertex(VertexConsumer p_114090_, MatrixStack.Entry normals, int p_114093_, float p_114094_, int p_114095_, int p_114096_, int p_114097_) {
        p_114090_.vertex(normals, p_114094_ - 0.5F, (float)p_114095_ - 0.25F, 0.0F).color(255, 255, 255, 255).texture((float)p_114096_, (float)p_114097_).overlay(OverlayTexture.DEFAULT_UV).light(p_114093_).normal(normals, 0.0F, 1.0F, 0.0F);
    }
