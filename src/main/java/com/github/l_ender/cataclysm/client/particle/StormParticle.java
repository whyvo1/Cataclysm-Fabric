...
public class StormParticle extends AbstractTrailParticle {
    ...
    public Vec3d getDinosaurPosition(){
    ...
    public Vec3d getOrbitPosition(){
        Vec3d dinoPos = getDinosaurPosition();
    ...
    public static class Factory implements ParticleFactory<StormParticleOptions> {

        @Override
        public Particle createParticle(StormParticleOptions data, ClientWorld level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
