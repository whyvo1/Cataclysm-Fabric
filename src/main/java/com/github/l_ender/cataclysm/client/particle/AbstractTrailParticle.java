...
public abstract class AbstractTrailParticle extends Particle {
    ...
    public void buildGeometry(VertexConsumer consumer, Camera camera, float partialTick) {
        if (trailPointer > -1) {
            ...
            MatrixStack.Entry lastPose = posestack.peek();
            Matrix4f matrix = lastPose.getPositionMatrix();
    ...
    private void addVertex(VertexConsumer consumer, Matrix4f matrix, Vec3d pos, Vec3d offset, float u, float v, int light) {
