...
public class Maledictus_Cicle_Layer extends FeatureRenderer<Maledictus_Entity, Maledictus_Model> {
    ...
    private void drawCircle(VertexConsumer vertex,MatrixStack.Entry normals, int packedLightIn, float r,float g,float b) {
    ...
    private static void cirlceVertex(VertexConsumer vertex, MatrixStack.Entry normals, int p_114093_, float p_114094_, int p_114095_, int p_114096_, int p_114097_, float alpha, float r,float g,float b) {
        vertex.vertex(normals, p_114094_ - 0.5F, (float)p_114095_ - 0.25F, 0.0F)
                .color(r, g, b,  alpha)
                .texture((float)p_114096_, (float)p_114097_)
                .overlay(DEFAULT_UV)
                .light(240)
