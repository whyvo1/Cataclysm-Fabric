...
public class Amethyst_Cluster_Projectile_Model extends AdvancedEntityModel<Amethyst_Cluster_Projectile_Entity> {
	...
	@Override
	public void setAngles(Amethyst_Cluster_Projectile_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
