...
public class Phantom_Wing_FlameParticle extends AbstractSlowingParticle {
    ...
    public static class EmissiveProvider implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_234094_, ClientWorld p_234095_, double p_234096_, double p_234097_, double p_234098_, double p_234099_, double p_234100_, double p_234101_) {
    ...
    public static class Provider implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_107750_, ClientWorld p_107751_, double p_107752_, double p_107753_, double p_107754_, double p_107755_, double p_107756_, double p_107757_) {
