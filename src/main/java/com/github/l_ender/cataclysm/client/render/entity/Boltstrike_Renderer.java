...
public class Boltstrike_Renderer extends EntityRenderer<Bolt_strike_Entity> {
    ...
    public void render(Bolt_strike_Entity entity, float p_115267_, float partialTicks, MatrixStack poseStack, VertexConsumerProvider p_115270_, int p_115271_) {
    ...
    public Identifier getTexture(Bolt_strike_Entity p_115264_) {
