...
//    public Phantom_Arrow_Entity(PlayMessages.SpawnEntity spawnEntity, World world) {
//        this(ModEntities.PHANTOM_ARROW, world);
//    }
    ...
    public void tick() {
        ...
        if (!this.getWorld().isClient) {
            ...
            this.getWorld().addParticle((new TrackLightningParticle.OrbData(26, 107,  89)), center.x, center.y, center.z, vec3.x, vec3.y, vec3.z);
