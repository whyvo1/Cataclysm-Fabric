...
public class Flame_Strike_Entity extends Entity {
    ...
    protected void initDataTracker() {
        ...
        this.getDataTracker().startTracking(DAMAGE, 0F);
        this.getDataTracker().startTracking(HPDAMAGE, 0F);
        this.getDataTracker().startTracking(DATA_WAITING, true);
        this.getDataTracker().startTracking(DATA_SEE, false);
        this.getDataTracker().startTracking(SOUL, false);
    }
