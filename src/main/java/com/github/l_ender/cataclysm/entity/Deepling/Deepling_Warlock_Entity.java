...
public class Deepling_Warlock_Entity extends AbstractDeepling {
    ...
    public static boolean candeeplingSpawn(EntityType<? extends Deepling_Warlock_Entity> guardian, WorldAccess level, SpawnReason spawnType, BlockPos pos, Random random) {
