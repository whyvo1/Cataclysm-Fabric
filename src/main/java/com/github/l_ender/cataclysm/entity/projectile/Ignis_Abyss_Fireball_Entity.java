...
public class Ignis_Abyss_Fireball_Entity extends ExplosiveProjectileEntity {
    ...
    protected void onEntityHit(EntityHitResult p_37626_) {
        ...
        if (!this.getWorld().isClient && !(p_37626_.getEntity() instanceof Ignis_Fireball_Entity ||  p_37626_.getEntity() instanceof Ignis_Abyss_Fireball_Entity || p_37626_.getEntity() instanceof Cm_Falling_Block_Entity || p_37626_.getEntity() instanceof Ignis_Entity && shooter instanceof Ignis_Entity) && getFired()) {
    ...
    protected void onBlockHit(BlockHitResult result) {
        ...
        if (!blockstate.getCollisionShape(this.getWorld(), traceResult.getBlockPos()).isEmpty() && getFired()) {
            ...
            this.powerX = motionX * 0.05D;
            this.powerY = motionY * 0.05D;
            this.powerZ = motionZ * 0.05D;
    ...
    protected void initDataTracker() {
        this.dataTracker.startTracking(BOUNCES, 0);
