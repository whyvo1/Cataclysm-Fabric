...
public class SemiAquaticAIRandomSwimming extends WanderAroundGoal {
    ...
    protected Vec3d getWanderTarget() {
        ...
        for(int i = 0; vector3d != null && !this.mob.getWorld().getFluidState(BlockPos.ofFloored(vector3d)).isIn(FluidTags.LAVA) && !this.mob.getWorld().getBlockState(BlockPos.ofFloored(vector3d)).canPathfindThrough(NavigationType.WATER) && i++ < 15; vector3d = NoPenaltyTargeting.find(this.mob, 10, 7)) {
        }
