...
public class ScreenShake_Entity extends Entity {
    ...
    public float getShakeAmount(LivingEntity living, float delta) {
        ...
        Vec3d playerPos = living.getCameraPosVec(delta);
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        p_326229_.add(RADIUS, 10.0f);
        p_326229_.add(MAGNITUDE, 1.0f);
        p_326229_.add(DURATION, 0);
        p_326229_.add(FADE_DURATION, 5);
    }
