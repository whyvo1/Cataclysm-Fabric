...
public class Death_Laser_Beam_Entity extends Entity {
    ...
    private void spawnExplosionParticles(int amount) {
        for (int i = 0; i < amount; i++) {
            ...
            getWorld().addParticle((new LightningParticle.OrbData(255, 26,  0)), collidePosX, collidePosY + 0.1, collidePosZ, motionX, motionY, motionZ);
        }
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(HEAD, 0);
        this.dataTracker.startTracking(FIRE, false);
