...
//    public Void_Shard_Entity(PlayMessages.SpawnEntity spawnEntity, World world) {
//        this(ModEntities.VOID_SHARD, world);
//    }
...
//    }
    ...
    protected void onBlockHit(BlockHitResult hit) {
        ...
        Vec3d Vec31 = Vec3.normalize().multiply(getGravity());
