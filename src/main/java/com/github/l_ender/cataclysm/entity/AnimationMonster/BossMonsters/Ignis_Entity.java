...
//    private final CMBossInfoServer bossInfo = new CMBossInfoServer(this.getDisplayName(), BossBar.Color.YELLOW, false, 2);
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        ...
        p_326229_.add(IS_BLOCKING, false);
        p_326229_.add(IS_SHIELD, false);
        p_326229_.add(IS_SHIELD_BREAK, false);
        p_326229_.add(SHIELD_DURABILITY, 0);
        p_326229_.add(IS_SWORD, false);
        p_326229_.add(SHOW_SHIELD, true);
        p_326229_.add(BOSS_PHASE, 0);
    }
    ...
    public void tick() {
        ...
        if (!this.getPassengerList().isEmpty() && this.getPassengerList().getFirst().isSneaking() && this.getAnimation() == POKED_ATTACK) {
    ...
    private void ShieldSmashparticle(float radius, float vec, float math) {
        if (this.getWorld().isClient) {
            ...
            this.getWorld().addParticle(new RingParticleOptions(0f, (float) Math.PI / 2f, 25, 255, 255, 255, 1f, 25f, false, 0), getX() + vec * vecX + f * math, getY() + 0.3f, getZ() + vec * vecZ + f1 * math, 0, 0, 0);
        }
    }
    ...
    public EntityData initialize(ServerWorldAccess p_29678_, LocalDifficulty p_29679_, SpawnReason p_29680_, @Nullable EntityData p_29681_) {
        return super.initialize(p_29678_, p_29679_, p_29680_, p_29681_);
    }
