...
public class Sandstorm_Projectile extends ProjectileEntity {
    ...
    public void tick() {
        ...
        if (this.getWorld().isClient || (entity == null || !entity.isRemoved()) && this.getWorld().isChunkLoaded(this.getBlockPos())) {
            ...
            this.getWorld().addParticle((new StormParticleOptions(r, g, b,0.25f + random.nextFloat() * 0.45f,0.35F + random.nextFloat() * 0.45f,this.getId())), this.getX(), this.getY(), this.getZ() , 0, 0, 0);
            if (!this.isSilent()) {
    ...
    protected void onCollision(HitResult p_37260_) {
        ...
        if (hitresult$type == HitResult.Type.ENTITY) {
            ...
            this.getWorld().emitGameEvent(GameEvent.PROJECTILE_LAND, p_37260_.getPos(), GameEvent.Emitter.of(this, null));
