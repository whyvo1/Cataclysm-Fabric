...
public class Amethyst_Crab_Entity extends LLibrary_Boss_Monster implements Angerable {
    ...
    public boolean canSpawn(WorldAccess worldIn, SpawnReason spawnReasonIn) {
        return ModEntities.rollSpawn(CMConfig.AmethystCrabSpawnRolls, this.getRandom(), spawnReasonIn) && super.canSpawn(worldIn, spawnReasonIn);
    }
    ...
    public void tickMovement() {
        ...
        if (this.getAnimation() == CRAB_SMASH) {
            if(this.getAnimationTick() == 22){
                ...
                this.playSound(ModSounds.EXPLOSION, 1.0f, 1F + this.getRandom().nextFloat() * 0.1F);
