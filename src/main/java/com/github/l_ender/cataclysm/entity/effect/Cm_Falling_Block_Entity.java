...
public class Cm_Falling_Block_Entity extends Entity {
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        p_326229_.add(DATA_START_POS, BlockPos.ORIGIN);
        p_326229_.add(BLOCK_STATE, Blocks.AIR.getDefaultState());
    }
    ...
    @Override
    public Packet<ClientPlayPacketListener> createSpawnPacket(EntityTrackerEntry p_352287_) {
        return new EntitySpawnS2CPacket(this, p_352287_, Block.getRawIdFromState(this.getBlockState()));
    }
