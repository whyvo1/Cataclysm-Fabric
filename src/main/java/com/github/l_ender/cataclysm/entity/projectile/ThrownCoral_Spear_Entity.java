...
public class ThrownCoral_Spear_Entity extends PersistentProjectileEntity {
    ...
    private ItemStack tridentItem = new ItemStack(ModItems.CORAL_SPEAR);
    ...
    public ThrownCoral_Spear_Entity(World p_37569_, LivingEntity p_37570_, ItemStack p_37571_) {
        super(ModEntities.CORAL_SPEAR, p_37570_, p_37569_);
    ...
    public void readCustomDataFromNbt(NbtCompound p_37578_) {
        ...
        if (p_37578_.contains("CoralSpear", 10)) {
            this.tridentItem = ItemStack.fromNbt(p_37578_.getCompound("CoralSpear"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound p_37582_) {
        ...
        p_37582_.put("CoralSpear", this.tridentItem.writeNbt(new NbtCompound()));
