...
public class The_Leviathan_Entity extends LLibrary_Boss_Monster implements ISemiAquatic,IHoldEntity, Partable {
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        ...
        p_326229_.add(BLAST_CHANCE, 0);
        p_326229_.add(MODE_CHANCE, 0);
        p_326229_.add(MELT_DOWN, false);
        p_326229_.add(TONGUE_UUID, Optional.empty());
        p_326229_.add(TONGUE_ID, -1);
    }
    ...
    public void tick() {
        ...
        if (!this.getPassengerList().isEmpty() && this.getPassengerList().getFirst().isSneaking() && this.getAnimation() == LEVIATHAN_TENTACLE_HOLD_BLAST) {
...
//                    PacketDistributor.sendToAllPlayers((new MessageMusic(this.getId(), false)));
                    NetworkHandler.sendToPlayersTrackingEntity(this, new MessageMusic(this.getId(), false));
                }
            }
...
//                    PacketDistributor.sendToAllPlayers((new MessageMusic(this.getId(), true)));
                    NetworkHandler.sendToPlayersTrackingEntity(this, new MessageMusic(this.getId(), true));
                }
                for(int i = 0; i < 3; ++i) {
                    motion = new Vec3d(0.5, -1.25, 0.5).rotateY(-(float)(120 * i) * 0.01745329251F);
