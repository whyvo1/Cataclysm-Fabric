...
public class Deepling_Brute_Entity extends AbstractDeepling {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(SPINATTACK, false);
    }
    ...
    public static boolean candeeplingSpawn(EntityType<Deepling_Brute_Entity> p_223364_0_, WorldAccess p_223364_1_, SpawnReason reason, BlockPos p_223364_3_, Random p_223364_4_) {
                ...
                if (target != null) {
                    if (this.getAnimationTick() == 11) {
                        if(this.isTouchingWaterOrRain() && !this.hasVehicle()) {
                            ...
                            this.playSound( SoundEvents.ITEM_TRIDENT_RIPTIDE_3,1.0F, 1.0F);
                        }else{
