...
public class LLibrary_Boss_Monster extends LLibrary_Monster implements IAnimatedEntity, Monster {
    private int reducedDamageTicks;
    private int homeTicks;
    public static final int HOME_COOLDOWN = CMConfig.Return_Home * 20;
    private static TrackedData<BlockPos> HOME_POS = DataTracker.registerData(LLibrary_Boss_Monster.class, TrackedDataHandlerRegistry.BLOCK_POS);

    public LLibrary_Boss_Monster(EntityType<? extends LLibrary_Boss_Monster> entity, World world) {
        super(entity, world);
    }
