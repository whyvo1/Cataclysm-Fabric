...
public class Draugr_Entity extends HostileEntity {
    ...
    protected void initGoals() {
        this.goalSelector.add(1, new Draugr_Entity.DraugrMeleeAttackGoal());
...
//        }
    ...
    class DraugrMeleeAttackGoal extends MeleeAttackGoal {
        ...
        protected double getSquaredMaxAttackDistance(LivingEntity p_33377_) {
            float f = Draugr_Entity.this.getWidth();
            return f * 2.25F * f * 2.25F + p_33377_.getWidth();
        }
    }
}
