...
public class Coral_Golem_Entity extends LLibrary_Monster implements ISemiAquatic {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(GOLEMSWIM, false);
    }
    ...
    public static boolean cangolemSpawn(EntityType<Coral_Golem_Entity> p_223364_0_, WorldAccess p_223364_1_, SpawnReason reason, BlockPos p_223364_3_, Random p_223364_4_) {
    ...
    protected void updatePassengerPosition(Entity p_289537_, Entity.PositionUpdater p_289541_) {
        ...
        p_289541_.accept(p_289537_, this.getX() + extraX, this.getBodyY(0.65D) + p_289537_.getHeightOffset() + 0.0D, this.getZ()+ extraZ);
