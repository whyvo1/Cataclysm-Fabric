...
public class Deepling_Priest_Entity extends AbstractDeepling {
    ...
    public static boolean candeeplingSpawn(EntityType<? extends Deepling_Priest_Entity> guardian, WorldAccess level, SpawnReason spawnType, BlockPos pos, Random random) {
