...
public class Aptrgangr_Entity extends Internal_Animation_Monster implements IHoldEntity {
    ...
    protected void dropEquipment(ServerWorld p_348503_, DamageSource p_34697_, boolean p_34699_) {
        ...
        if (p_34697_.getAttacker() instanceof CreeperEntity creeper && creeper.shouldDropHead()) {
            ItemStack itemstack = new ItemStack(ModItems.APTRGANGR_HEAD);
    ...
    public void tick() {
        ...
        if (!this.getPassengerList().isEmpty() && this.getPassengerList().getFirst().isSneaking() && this.getAttackState() == 4) {
