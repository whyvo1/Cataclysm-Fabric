...
public class Modern_Remnant_Entity extends LLibraryAnimationPet implements Bucketable {
    ...
    public void copyDataFromNbt(NbtCompound p_148832_) {
        ...
        if (p_148832_.contains("ModernRemnantData")) {
            this.readCustomDataFromNbt(p_148832_.getCompound("ModernRemnantData"));
        }
    }
    ...
    public ItemStack getBucketItem() {
        return new ItemStack(ModItems.MODERN_REMNANT_BUCKET);
    }
...
//            }
        ...
        if (isTamed() && itemstack.isIn(ModTag.BONE_ITEM)) {
