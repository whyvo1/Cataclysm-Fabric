...
public class TameableAIFollowOwnerWater extends Goal {
    ...
    private boolean isTeleportFriendlyBlock(BlockPos pos) {
        PathContext pathfindingcontext = new PathContext(this.world, this.tameable);
        PathNodeType blockPathType = LandPathNodeMaker.getLandNodeType(pathfindingcontext, pos.mutableCopy());
