...
public class ThrownCoral_Bardiche_Entity extends PersistentProjectileEntity {
    ...
    public ThrownCoral_Bardiche_Entity(World p_37569_, LivingEntity p_37570_, ItemStack p_37571_) {
        super(ModEntities.CORAL_BARDICHE, p_37570_, p_37569_, p_37571_, null);
        this.dataTracker.set(ID_LOYALTY, this.getLoyaltyFromItem(p_37571_));
        this.dataTracker.set(ID_FOIL, p_37571_.hasGlint());
    }

    public ThrownCoral_Bardiche_Entity(World p_338686_, double p_338771_, double p_338674_, double p_338477_, ItemStack p_338255_) {
        super(ModEntities.CORAL_BARDICHE, p_338771_, p_338674_, p_338477_, p_338686_, p_338255_, p_338255_);
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.CORAL_BARDICHE);
    }
