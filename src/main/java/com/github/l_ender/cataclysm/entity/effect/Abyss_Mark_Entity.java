...
public class Abyss_Mark_Entity extends Entity {
    ...
    public Abyss_Mark_Entity(World worldIn, double x, double y, double z, int lifespan, float damage, float hpdamage, UUID casterIn, @Nullable LivingEntity finalTarget) {
