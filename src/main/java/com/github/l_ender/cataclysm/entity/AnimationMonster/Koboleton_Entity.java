...
//                            Optional<SlotResult> slot = CuriosApi.getCuriosHelper().findFirstCurio(target, stack -> stack.is(ModItems.STICKY_GLOVES.get()));
    ...
    public static boolean checkKoboletonSpawnRules(EntityType<Koboleton_Entity> p_218997_, ServerWorldAccess p_218998_, SpawnReason p_218999_, BlockPos p_219000_, Random p_219001_) {
        return canSpawnInDark(p_218997_, p_218998_, p_218999_, p_219000_, p_219001_) && (p_218999_ == SpawnReason.SPAWNER || p_218998_.isSkyVisible(p_219000_));
    }
    ...
    static class AnimationMeleeAttackGoal extends MeleeAttackGoal {
        ...
        protected double getSquaredMaxAttackDistance(LivingEntity p_25556_) {
