...
public class The_Leviathan_Tongue_Entity extends Entity {
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        p_326229_.add(CONTROLLER_UUID, Optional.empty());
        p_326229_.add(CONTROLLER_ID, -1);
        p_326229_.add(TARGET_ID, -1);
        p_326229_.add(DURATION, 0);
        p_326229_.add(MAX_DURATION, 0);
        p_326229_.add(COMING_BACK, false);
    }
    ...
    public void tick() {
        ...
        if (!this.getPassengerList().isEmpty() && this.getPassengerList().getFirst().isSneaking()) {
