...
public class MovementControllerCustomCollisions extends MoveControl {
    ...
    private boolean isPosWalkable(float p_234024_1_, float p_234024_2_) {
        ...
        if (pathnavigator != null) {
            ...
            return nodeprocessor == null || nodeprocessor.getDefaultNodeType(this.entity, BlockPos.ofFloored(MathHelper.floor(this.entity.getX() + (double)p_234024_1_), MathHelper.floor(this.entity.getY()), MathHelper.floor(this.entity.getZ() + (double)p_234024_2_))) != PathNodeType.WALKABLE;
