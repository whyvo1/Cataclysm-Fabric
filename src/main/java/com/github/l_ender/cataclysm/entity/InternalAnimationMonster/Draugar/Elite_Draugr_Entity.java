...
public class Elite_Draugr_Entity extends Internal_Animation_Monster implements CrossbowUser {
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        ...
        p_326229_.add(IS_CHARGING_CROSSBOW, false);
    }
...
protected void dropEquipment(ServerWorld p_348503_, DamageSource p_34697_, boolean p_34699_) {
    ...
    @Override
    public void shootAt(LivingEntity p_33317_, float p_33318_) {
    ...
    static class CrossBowReloadGoal extends Goal {
        ...
        public void tick() {
            ...
            if (i >= CrossbowItem.getPullTime(itemstack,this.entity)) {
        ...
        public void tick() {
           ...
           if(this.entity.getAttackState() == 2) {
               if(target != null && entity.attackTicks == 10) {
                   this.entity.shootAt(target, 1.0F);
        ...
        public void tick() {
            ...
            if(target != null && entity.attackTicks == 11) {
                ...
                if(isHoldingCrossbow()) {
                    this.entity.getActiveItem().set(DataComponentTypes.CHARGED_PROJECTILES, ChargedProjectilesComponent.DEFAULT);
                }
                this.entity.setCharging(false);
            }
        }
