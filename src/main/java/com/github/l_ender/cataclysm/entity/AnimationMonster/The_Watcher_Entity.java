...
//                    Laser_Beam_Entity laserBeam = new Laser_Beam_Entity(this.getWorld(), this);
//                    laserBeam.setVelocity(d3, d4, d5, 1F, 1F);
//                    laserBeam.setDamage((float) CMConfig.HarbingerLaserdamage);
                    Vec3d vec3 = new Vec3d(d3, d4, d5);
                    Laser_Beam_Entity laserBeam = new Laser_Beam_Entity(this, d3,d4,d5,this.getWorld(),(float) CMConfig.HarbingerLaserdamage);
