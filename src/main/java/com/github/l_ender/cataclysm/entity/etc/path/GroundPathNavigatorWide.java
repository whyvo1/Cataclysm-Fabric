...
public class GroundPathNavigatorWide extends MobNavigation {
    ...
    protected void continueFollowingPath() {
        ...
        if (flag || this.canJumpToNext(this.currentPath.getCurrentNode().type) && this.shouldJumpToNextNode(vector3d)) {
    ...
    private boolean shouldJumpToNextNode(Vec3d currentPosition) {
