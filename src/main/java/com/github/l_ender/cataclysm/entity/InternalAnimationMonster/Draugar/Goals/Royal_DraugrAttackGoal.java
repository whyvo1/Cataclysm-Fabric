...
public class Royal_DraugrAttackGoal extends Goal {
   ...
   public void tick() {
      ...
      if (livingentity != null) {
         ...
         double d0 = this.mob.getSquaredDistanceToAttackPosOf(livingentity);
         this.ticksUntilNextPathRecalculation = Math.max(this.ticksUntilNextPathRecalculation - 1, 0);

         if(!isShieldDisabled(mob) && mob.getOffHandStack().isIn(ConventionalItemTags.SHIELDS) &&  this.mob.getRandom().nextInt(6) == 0){
