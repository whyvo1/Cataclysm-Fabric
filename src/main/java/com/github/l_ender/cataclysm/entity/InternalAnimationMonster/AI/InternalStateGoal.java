...
public class InternalStateGoal extends Goal {
    ...
    public InternalStateGoal(Internal_Animation_Monster entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, EnumSet<Control> interruptFlagTypes) {
        this.entity = entity;
