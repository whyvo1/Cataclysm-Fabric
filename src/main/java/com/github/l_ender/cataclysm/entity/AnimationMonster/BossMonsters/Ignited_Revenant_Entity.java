        ...
        if (!this.getWorld().isClient) {
            if(this.getIsAnger()) {
                if (entity instanceof LivingEntity) {
                    ...
                    if (((LivingEntity) entity).getMainHandStack().getItem() instanceof AxeItem) {
                        double itemDamage = ((AxeItem) ((LivingEntity) entity).getMainHandStack().getItem()).getAttackDamage()+ 1;
