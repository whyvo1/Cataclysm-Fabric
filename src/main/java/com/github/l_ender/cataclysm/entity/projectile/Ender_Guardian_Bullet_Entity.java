...
public class Ender_Guardian_Bullet_Entity extends ExplosiveProjectileEntity {
    ...
    public Ender_Guardian_Bullet_Entity(World worldIn, LivingEntity shooter, Vec3d accel) {
        super(ModEntities.ENDER_GUARDIAN_BULLET, shooter, accel, worldIn);
    }
    ...
    protected void onEntityHit(EntityHitResult result) {
        ...
        if (this.getWorld() instanceof ServerWorld serverlevel) {
            if (fired) {
                ...
                boolean flag = entity.damage(damagesource, 6.0F);
                if (flag) {
