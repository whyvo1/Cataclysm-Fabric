...
public class AnimationPet extends TameableEntity implements IFollower {
    ...
    private static final Identifier MOB_HEALTH_MODIFIER_ID = Cataclysm.modIdentifier("pet_health");
    private static final Identifier MOB_DAMAGE_MODIFIER_ID = Cataclysm.modIdentifier("pet_damage");
    ...
    protected void initDataTracker(DataTracker.Builder p_326229_) {
        ...
        p_326229_.add(COMMAND, 0);
        p_326229_.add(SITTING, Boolean.FALSE);
    }
