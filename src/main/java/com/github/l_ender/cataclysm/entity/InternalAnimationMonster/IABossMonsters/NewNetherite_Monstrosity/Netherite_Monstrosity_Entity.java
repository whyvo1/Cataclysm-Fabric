...
public class Netherite_Monstrosity_Entity extends IABoss_monster implements Partable {
    ...
    public Netherite_Monstrosity_Entity(EntityType<Netherite_Monstrosity_Entity> entity, World world) {
        super(entity, world);
        this.experiencePoints = 500;
        this.setStepHeight(4.5F);
...
//        }
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(MAGAZINE, 0);
    }
            ...
            if(target !=null) {
                if (this.entity.attackTicks == attackshot) {
                    for (int i = 0; i < lavabombcount; ++i) {
                        ...
                        double d3 = MathHelper.sqrt((float) (d0 * d0 + d2 * d2));
                        lava.setVelocity(d0, d1 + d3 * 0.20000000298023224D, d2, 1.0F, 1 + i * 8);
                        this.entity.getWorld().spawnEntity(lava);
                    }
                }
            }
