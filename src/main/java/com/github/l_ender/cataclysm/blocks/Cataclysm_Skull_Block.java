...
public class Cataclysm_Skull_Block extends Abstract_Cataclysm_Skull_Block {
    public static final MapCodec<Cataclysm_Skull_Block> CODEC = RecordCodecBuilder.mapCodec(
            p_308836_ -> p_308836_.group(Cataclysm_Skull_Block.Type.CODEC.fieldOf("kind").forGetter(Cataclysm_Skull_Block::getType), createSettingsCodec())
    ...
    public Cataclysm_Skull_Block(Type p_56318_, AbstractBlock.Settings p_56319_) {
        super(p_56318_, p_56319_);
        this.setDefaultState(this.stateManager.getDefaultState().with(ROTATION, 0));
    }

    @Override
    public MapCodec<? extends Cataclysm_Skull_Block> getCodec() {
        return CODEC;
    }
    ...
    public interface Type extends StringIdentifiable {
        Map<String, Type> TYPES = new Object2ObjectArrayMap<>();
        Codec<Type> CODEC = Codec.stringResolver(StringIdentifiable::asString, TYPES::get);
    }
