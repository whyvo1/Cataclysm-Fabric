...
public class Altar_Of_Abyss_Block extends BlockWithEntity implements Waterloggable {
    ...
    public ActionResult onUse(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockHitResult hit) {
        ...
        if (worldIn.getBlockEntity(pos) instanceof AltarOfAbyss_Block_Entity aof && (!player.isSneaking() && heldItem.getItem() != this.asItem())) {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World p_152180_, BlockState p_152181_, BlockEntityType<T> p_152182_) {
        return checkType(p_152182_, ModTileentites.ALTAR_OF_ABYSS, AltarOfAbyss_Block_Entity::commonTick);
    }
