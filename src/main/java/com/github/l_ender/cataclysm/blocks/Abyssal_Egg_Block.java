...
public class Abyssal_Egg_Block extends BlockWithEntity implements Waterloggable {
    public static final MapCodec<Abyssal_Egg_Block> CODEC = createCodec(Abyssal_Egg_Block::new);
    ...
    @Override
    public MapCodec<Abyssal_Egg_Block> getCodec() {
        return CODEC;
    }

    public Abyssal_Egg_Block(AbstractBlock.Settings p_54257_) {
        super(p_54257_);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World p_152180_, BlockState p_152181_, BlockEntityType<T> p_152182_) {
        return validateTicker(p_152182_, ModTileentites.ABYSSAL_EGG, Abyssal_Egg_Block_Entity::commonTick);
    }
}