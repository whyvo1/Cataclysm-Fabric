...
public class Sandstone_Ignite_Trap extends BlockWithEntity {
    public static final MapCodec<Sandstone_Ignite_Trap> CODEC = createCodec(Sandstone_Ignite_Trap::new);
    ...
    @Override
    public MapCodec<Sandstone_Ignite_Trap> getCodec() {
        return CODEC;
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World p_152180_, BlockState p_152181_, BlockEntityType<T> p_152182_) {
        return validateTicker(p_152182_, ModTileentites.SANDSTONE_IGNITE_TRAP, SandstoneIgniteTrap_Block_Entity::commonTick);
    }
